        ...
        <form action="<?=base_url('modificar_hotel')?>" method="post">
            <div class="mb-3">
                <label for="txtIdHotel" class="form-label">Id del Hotel</label>
                 <input type="number" class="form-control" id="txtIdHotel" name="txtIdHotel" placeholder="Ingrese Codigo de Departamento" value="<?=$datos['hotel_id'];?>" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="txtCorreo" class="form-label">Correo Electrónico</label>
                 <input type="email" class="form-control" id="txtCorreo" name="txtCorreo" placeholder="Ingrese la region (1 al 8) para el Departamento" value="<?=$datos['correoelectronico'];?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="txtDireccion" class="form-label">Dirección</label>
                 <input type="text" class="form-control" id="txtDireccion" name="txtDireccion" placeholder="Ingrese la region (1 al 8) para el Departamento" value="<?=$datos['direccion'];?>">
            </div>
            <div class="mb-3">
                <label for="txtCiudad" class="form-label">Id de Ciudad</label>
                 <input type="number" class="form-control" id="txtCiudad" name="txtCiudad" placeholder="Ingrese la region (1 al 8) para el Departamento" value="<?=$datos['ciudad_id'];?>">
            </div>
            <div class="mb-3">
                <label for="txtIdCategoria" class="form-label">Id de Categoria </label>
                 <input type="number" class="form-control" id="txtIdCategoria" name="txtIdCategoria" placeholder="Ingrese la region (1 al 8) para el Departamento" value="<?=$datos['categoria_id'];?>">
            </div>
            <div class="mb-3">
                <label for="txtIdUsuario" class="form-label">Id de Usiario</label>
                 <input type="number" class="form-control" id="txtIdUsuario" name="txtIdUsuario" placeholder="Ingrese la region (1 al 8) para el Departamento" value="<?=$datos['usuario_id'];?>">
